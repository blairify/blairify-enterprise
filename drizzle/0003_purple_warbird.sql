...
--> statement-breakpoint
ALTER TABLE "candidates" ADD CONSTRAINT "candidates_enterprise_id_enterprises_id_fk" FOREIGN KEY ("enterprise_id") REFERENCES "public"."enterprises"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "public_interview_attempts_link_candidate_unique" ON "public_interview_attempts" USING btree ("public_interview_link_id","candidate_id");--> statement-breakpoint
...
CREATE INDEX "public_interview_attempts_link_id_idx" ON "public_interview_attempts" USING btree ("public_interview_link_id");--> statement-breakpoint
CREATE UNIQUE INDEX "public_interview_candidates_link_email_unique" ON "public_interview_candidates" USING btree ("public_interview_link_id","email");--> statement-breakpoint
...
CREATE UNIQUE INDEX "public_interview_links_public_id_unique" ON "public_interview_links" USING btree ("public_id");--> statement-breakpoint
...
CREATE INDEX "public_interview_links_recruiter_id_idx" ON "public_interview_links" USING btree ("recruiter_id");